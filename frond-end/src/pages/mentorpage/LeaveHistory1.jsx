...
function LeaveHistoryMentor() {
  ...
  // Initial fetch + optional refresh
  useEffect(() => {
    fetchLeaves();

    // Optional: auto-refresh every 10s to see admin updates in real-time
            ...
            leaves.map((leave) => (
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-gray-700">From: {leave.from}</p>
                  <p className="text-gray-700">To: {leave.to}</p>
