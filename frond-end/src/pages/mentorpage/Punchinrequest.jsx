...
function Punchinrequest() {
  ...
  const fetchRequests = async () => {
    try {
      // Don't set loading for refresh, just show spinner on refresh button
    ...
    <div className="min-h-screen bg-[#EEF6FB]">
      ...
      <div className="lg:ml-64 flex-1 min-h-screen p-3 sm:p-4 md:p-6 lg:p-8">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* STATS CARDS */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6">
            {/* Pending Requests Card */}
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-5 border hover:scale-105 transition border-yellow-200">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm sm:text-base font-semibold text-gray-700">Pending</h3>
            ...
            {/* Accepted Today Card */}
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-5 border hover:scale-105 transition border-green-200">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm sm:text-base font-semibold text-gray-700">Accepted Today</h3>
            ...
            {/* Rejected Today Card */}
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-5 border hover:scale-105 transition border-red-200">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm sm:text-base font-semibold text-gray-700">Rejected Today</h3>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden">
            {/* Filter Bar & Tabs */}
            <div className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-4 bg-white border-b border-gray-100">
              <div className="flex flex-col lg:flex-row flex-wrap gap-3 lg:gap-4 items-stretch lg:items-center mb-4">
              ...
              <div className="border-b border-gray-200 overflow-x-auto">
                <nav className="flex flex-nowrap -mb-px">
                  {[
                    ...
                    { key: "acceptedToday", label: "Today", count: acceptedTodayCount },
                    { key: "all", label: "All", count: totalRequests },
                  ].map((tab) => (
                    <button
                      key={tab.key}
                      onClick={() => setActiveTab(tab.key)}
                      className={`flex items-center px-3 sm:px-4 py-3 mr-2 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${
                        activeTab === tab.key
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">{req.studentId?.batch || "N/A"} | {req.studentId?.course || "N/A"}</p>
                          </div>
                        </div>
