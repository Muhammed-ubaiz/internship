    ...
    <div className="min-h-screen bg-[#EEF6FB] p-6">
      ...
      <div className="ml-[225px] max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-2xl p-5 border border-gray-200 hover:scale-105 transition">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="w-full h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 flex justify-center items-center">
            <LiveClockUpdate />
          </div>
